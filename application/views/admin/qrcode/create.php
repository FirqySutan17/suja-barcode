...
<div class="main-content pre-posttest">
    ...
    <div class="row w-form">
        <div class="c-form">
            <form  method="POST" enctype="multipart/form-data" action="<?= admin_url('qr-code/generate') ?>">
                ...
                <div class="form-group row mt-5">
                    <div class="col-lg-12 col-sm-12" style="display: flex;">
                        <a href="<?= admin_url('qr-code') ?>" class="btn btn-primary cust-btn-back" style="width: 50%">CANCEL</a>
                        <span style="margin: 5px;"></span>
                        <button type="submit" class="btn btn-primary cust-btn-save" style="width: 50%">GENERATE QR</button>
                    </div>
                </div>
